...
$(document).ready(function () {
  $(".customizer-color li").on('click', function () {
    ...
    $("#color").attr("href", "../../public/assets/css/" + color + ".css");
      ...
      case 'normal-sidebar':
        {
          ...
          $(".logo-wrapper").find('img').attr('src', '../../public/assets/images/logo/logo.png');
